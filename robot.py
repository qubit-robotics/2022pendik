...
class MyRobot(magicbot.MagicRobot):
    ...
    def createObjects(self):
        ...
        # self.belt_lower = ctre.VictorSPX(1)
        # self.belt_upper = ctre.VictorSPX(2)

        self.switch_upper = wpilib.DigitalInput(1)
        self.switch_lower = wpilib.DigitalInput(2)

        # self.shooter_front1 = ctre.VictorSPX(3)
        # self.shooter_front2 = ctre.VictorSPX(4)
        # self.shooter_rear = ctre.VictorSPX(5)
